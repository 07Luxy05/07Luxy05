...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        ...
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "iori"}" placeholder="Nickname" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
...
<a href="./luxy.html" class="ui right floated
      ...
      try {
        ...
        if (people) {
          ...
          if (regex.test(username)) {
            document.querySelector('#botname div input').value = "luxy";
            username = "";
          }
        }
...
document.querySelector("#send").addEventListener("click", function () {
  ...
  if (regex.test(messagetext)) {
    document.querySelector('#messagetext input').value = "luxy";
    messagetext = "luxy";
  }
    ...
    socketList.forEach((socket) => {
      if (socket.readyState === WebSocket.OPEN) {
        ...
        if (regex.test(spamtext)) {
          document.querySelector('#spamtext input').value = "luxy";
          spamtext = "luxy";
        }
